    ...
    render(){        
        ...
        return (
            <div className = "root">                   
                ...
                <div alt = "logoishere">
                    There may or may not be a logo here.
                </div>

                <div className = "button-state">{this.state.on ? "Clicked." : "Unclicked."}</div>
...
export class Link extends Component{
    render(){
        return this.props.hide ? null : <a href = {this.props.address}>Button To Click</a>;
    }
}
